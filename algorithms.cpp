...
namespace graph {
     ...
     * Used for BFS traversal and general queue operations.
     *
    ...
    /**
     * A basic priority queue implementation using arrays.
     * Supports insertion, priority update, and extraction of minimum.
     *
     * @param cap The number of unique items the queue can support.
     */
     ...
     * @param prio  The priority associated with the value.
     */
    ...
    /**
     * Updates the priority of an existing element if the new priority is lower.
     *
     ...
     *
     * @return The value with the lowest priority, or -1 if empty.
     */
